...
# Checkpoint paths
CHECKPOINT_S3_PATH="s3://arc-agi/finetune-phase1/phase1_checkpoint.pt"
CHECKPOINT_DEST_DIR="/root/checkpoints/phase1"
CHECKPOINT_DEST_FILE="${CHECKPOINT_DEST_DIR}/phase1_checkpoint.pt"
...
echo "Downloading Phase 1 checkpoint..."
